...
mongodb_video_uri = f"mongodb+srv://{MONGODB_USERNAME}:{MONGODB_PASSWORD}@{MONGODB_CLUSTER_URL}/videos"
mongodb_mp3_uri = f"mongodb+srv://{MONGODB_USERNAME}:{MONGODB_PASSWORD}@{MONGODB_CLUSTER_URL}/mp3s"
...
# The service of our RabbitMQ broker will be called "rabbitmq"
...
def register():
    ...
    response, err = access.register(json_request)
